    ...
    <div className="about flex items-center justify-center">
      <div className="container mx-auto relative flex gap-10">
        ...
        <div className="flex flex-col gap-5 about-title">
          ...
          <p>
            Perumnas IIDA Group didirikan di Indonesia sejak October 2017 <br />
          ...
          <p>
            ...
            pertahunnya, <br />
            yang mana sekitar 30% penduduk Jepang memiilih tempat tinggal <br />
            yang diproduksi oleh IIDA Group.
          </p>
          <div className="flex justify-around mt-10">
            {statistics.map((stat) => (
              <div className="flex flex-col gap-2 text-[#EBBE63] text-center leading-8">
                <div>
                  <h1>{stat.value}</h1>
                </div>
                <div>
